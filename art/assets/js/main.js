(() => {
  ...
  const focusData = {
    markets: {
      title: 'Studies as evidence',
      copy: 'The rough study is not a lesser version of the final work. It is proof of contact: hand, eye, error, material, and time in the same place.'
    },
    builders: {
      title: 'Rooms as arguments',
      copy: 'A room is not just a category. It is a visual argument made through sequence, distance, repetition, blank space, and tiny interruptions of color.'
    },
    systems: {
      title: 'Notes as texture',
      copy: 'Captions, catalog cards, marginalia, and fragments should behave like marks on the page: useful, precise, and slightly human.'
    },
    future: {
      title: 'Objects as witnesses',
      copy: 'Physical pieces, editions, found materials, and photographed artifacts carry memory differently than images. They make the archive feel touched.'
    }
  };
