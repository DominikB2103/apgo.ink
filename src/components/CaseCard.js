...
export function CaseCard(demo){
  return html`<a href="${demo.href}" class="case-card card reveal" style="--theme:${demo.theme}">
    <div class="case-visual"><img src="${demo.image}" alt="${demo.name} website example visual" loading="lazy"></div>
